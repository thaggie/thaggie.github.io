  ...
  [179],
  {
    ...
    8204: function (e, t, r) {
      ...
      async function K(e) {
        ...
        let t = o.assetPrefix || "";
        if (
          (self.__next_set_public_path__("" + t + "/grandpa/"),
          (0, w.setConfig)({
            serverRuntimeConfig: {},
    ...
    3828: function (e, t, r) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }), r(3335);
      let n = r(8204);
      (window.next = {
        version: n.version,
        get router() {
    ...
    7968: function (e, t, r) {
      ...
      function h(e, t) {
        return p().then((r) => {
          ...
          let o = r[t].map((t) => e + "/grandpa/" + encodeURI(t));
          return {
            scripts: o
    ...
    1613: function (e, t, r) {
      ...
      function u(e) {
        ...
        return (
          ...
          e.buildId &&
            (t = (0, a.addPathSuffix)(
              (0, o.addPathPrefix)(t, "/grandpa/data/" + e.buildId),
    ...
    4776: function (e, t, r) {
      ...
      function i(e, t) {
        ...
        let f = c.pathname;
        if (
          c.pathname.startsWith("/grandpa/data/") &&
